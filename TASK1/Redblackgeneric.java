...
public class Redblackgeneric<T extends Comparable<T>> {
...
private void printHelper(Node root, String indent, boolean last) {
	...
	/*public Node createBlackNode(T Item)
	{
		Node new_node = new Node();
		new_node.data = Item;
		new_node.color = Color.BLACK;
		new_node.left = createNullleafNode(new_node);
		new_node.right = createNullleafNode(new_node);
		return new_node;
		
	}
	public Node createNullleafNode(Node p)
	{
		
		Node leafnode = new Node();
		leafnode.color = Color.BLACK;
		leafnode.isNullLeaf = true;
		leafnode.parent = p;
		return leafnode;
		
		
	}
	public Node createRedNode(Node parent , T Item)
	{
